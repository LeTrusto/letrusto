"""Restore the historical property scaffold revision for migration compatibility.

Revision ID: 20260921_45
Revises: 20260908_44

This revision was applied to the production database before the Bangalore pivot
baseline was introduced. It remains in the graph so existing databases can
upgrade to the current head; the following pivot baseline removes these tables.
"""
