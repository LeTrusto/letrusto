...
const faqs = [
  ...
  ["How does billing work?", "Plans are billed monthly through Razorpay. You can manage your plan from LeTrusto at any time."],
];
...
function PlanCard({ plan, currency }: { plan: (typeof plans)[number]; currency: "INR" | "USD" }) {
  const displayPrice = currency === "USD" ? Math.round(plan.monthly / 83) : plan.monthly;
