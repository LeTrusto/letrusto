  ...
  return (
    <div className="border border-[#b8cec5] bg-[#e8f1ee] p-4 shadow-[0_16px_35px_-22px_rgba(23,60,50,0.65)] sm:p-6">
      <div className="border border-[#b8cec5] bg-[#f7fbf8] p-4 sm:p-6">
        <div className="flex items-start justify-between gap-4 border-b border-[#c9dcd4] pb-5"><div><p className="text-[10px] font-bold uppercase tracking-[0.14em] text-[#28604e]">{product.previewLabel}</p><h2 className="mt-2 text-xl font-black text-[#173c32] sm:text-2xl">Monthly finance dashboard</h2></div><span className="border border-[#b8cec5] bg-white px-2 py-1 text-[10px] font-bold text-[#28604e]">SHEET 01</span></div>
        <div className="mt-5 grid gap-3 sm:grid-cols-3"><Metric label="Revenue" value="₹1,20,000" /><Metric label="Expenses" value="₹68,500" /><Metric label="Operating profit" value="₹51,500" /></div>
