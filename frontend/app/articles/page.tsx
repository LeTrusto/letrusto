...
export const metadata: Metadata = {
  title: "Buying Guides & Reviews — LeTrusto",
  description: "Expert buying guides, product comparisons, and honest reviews to help you make the best purchase decision.",
};
...
export default async function ArticlesPage() {
  ...
  return (
    <main className="mx-auto max-w-4xl px-6 py-12">
      <div className="mb-10">
        <h1 className="text-4xl font-black text-gray-900">Buying Guides & Reviews</h1>
        <p className="mt-3 text-lg text-gray-500">
          Expert guides to help you decide before you buy.
        </p>
      </div>
      ...
      {articles.length === 0 ? (
        <div className="rounded-2xl border border-dashed border-gray-200 py-20 text-center">
          ...
          <Link href="/ai" className="mt-6 inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-purple-600 to-pink-600 px-6 py-3 text-sm font-bold text-white">
            ✨ Ask our AI instead
          </Link>
        </div>
      ) : (
