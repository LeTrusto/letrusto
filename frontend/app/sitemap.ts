...
const STATIC_ROUTES: MetadataRoute.Sitemap = [
  ...
  { url: `${BASE_URL}/guides/highlevel-pricing`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
  { url: `${BASE_URL}/guides/moosend-pricing`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
  { url: `${BASE_URL}/guides/beehiiv-pricing`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
  { url: `${BASE_URL}/guides/synthesia-pricing`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
  { url: `${BASE_URL}/guides/beehiiv-vs-substack`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
  { url: `${BASE_URL}/ai-tools/highlevel`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
  { url: `${BASE_URL}/ai-tools/moosend`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
  { url: `${BASE_URL}/ai-tools/beehiiv`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
  { url: `${BASE_URL}/ai-tools/synthesia`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
  ...
  { url: `${BASE_URL}/methodology`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.55 },
